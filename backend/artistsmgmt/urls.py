...
from . views import send_sms, SendEmailView, PublicArtistBioDetailView, SkillsListCreateAPIView
...
urlpatterns = [
    ...
    # Skills
     path('skills/', SkillsListCreateAPIView.as_view(), name='skills-list-create'),
